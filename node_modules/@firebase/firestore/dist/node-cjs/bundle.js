...
function loadBundle(data) {
    return database5268acb9.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database5268acb9.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database5268acb9.Query$1(_this, 
...
registerBundle(database5268acb9.Firestore);
