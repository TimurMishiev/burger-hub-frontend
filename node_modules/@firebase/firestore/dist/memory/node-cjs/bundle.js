...
function loadBundle(data) {
    return databaseBad768ce.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return databaseBad768ce.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new databaseBad768ce.Query$1(this, 
...
registerBundle(databaseBad768ce.Firestore);
