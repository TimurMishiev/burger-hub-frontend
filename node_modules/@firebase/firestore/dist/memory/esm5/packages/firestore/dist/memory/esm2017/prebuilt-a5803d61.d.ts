/** Immutable class holding a blob (binary data) */ declare class $u extends Nc {
    static fromBase64String(t: any): $u;
    static fromUint8Array(t: any): $u;
    constructor(t: any);
    toBase64(): any;
    toUint8Array(): any;
    isEqual(t: any): any;
...
/** A CredentialsProvider that always yields an empty token. */ declare class $ {
    /**
...
declare namespace M {
    const UNAUTHENTICATED: M;
    const R: M;
    const P: M;
}
export { $u as $, Gu as G, Hu as H, Qu as Q, Wu as W, Xa as X, Ya as Y, Zc as Z, Zu as a, ah as b, ch as c, eh as e, ih as i, ju as j, oh as o, qu as q, sh as s, th as t, uh as u };
